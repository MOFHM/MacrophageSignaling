...
for (i in 1:length(sheets)){
  ...
  centralities <- centralities[match(sort(centralities$Current_Flow_Betweenness_Centrality,decreasing = TRUE),centralities$Current_Flow_Betweenness_Centrality),which(colnames(centralities) %in% c("Current_Flow_Betweenness_Centrality","Symbol"))]
